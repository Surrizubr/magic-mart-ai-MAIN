...
const translations: Record<string, Record<Lang, string>> = {
  ...
  selectJsonFile: { pt: 'Selecionar arquivo .json', en: 'Select .json file', es: 'Seleccionar archivo .json' },
  ...
  confirmRestore: { pt: 'Deseja restaurar os dados? Todos os dados atuais serão substituídos.', en: 'Do you want to restore the data? All current data will be replaced.', es: '¿Deseas restaurar los datos? Todos los datos actuales serán reemplazados' },
  ...
  savings: { pt: 'Economizar', en: 'Save', es: 'Ahorrar' },
  savingsAnalysis: { pt: 'Análise de preços e economia', en: 'Price and savings analysis', es: 'Análisis de precios y ahorro' },
  ...
  recentPurchase: { pt: 'Compra Recente', en: 'Recent Purchase', es: 'Compra Reciente' },
  ...
  emptyListText: { pt: '(lista vazia)', en: '(empty list)', es: '(lista vacía)' },
  ...
  selectAtLeastOne: { pt: 'Selecione pelo menos uma lista', en: 'Select at least one list', es: 'Selecciona al menos una lista' },
  ...
  shopping: { pt: 'Fazer Mercado', en: 'Go Shopping', es: 'Ir al Mercado' },
  ...
  locationObtained: { pt: 'Localização obtida!', en: 'Location obtained!', es: '¡Ubicación obtenida!' },
  coordsSaved: { pt: 'Coordenadas salvas.', en: 'Coordinates saved.', es: 'Coordenadas guardadas.' },
  locationError: { pt: 'Não foi possível obter localização', en: 'Could not obtain location', es: 'No se pudo obtener la ubicación' },
  ...
  addItem: { pt: 'Adicionar item', en: 'Add item', es: 'Añadir ítem' },
  newItem: { pt: 'Novo item', en: 'New item', es: 'Nuevo ítem' },
  
  developerMode: { pt: 'Modo Desenvolvedor', en: 'Developer Mode', es: 'Modo Desarrollador' },
  diagnosticTools: { pt: 'Ferramentas de diagnóstico e API', en: 'Diagnostic and API tools', es: 'Herramientas de diagnóstico y API' },
  geminiConfig: { pt: 'Configuração Gemini API', en: 'Gemini API Configuration', es: 'Configuración de Gemini API' },
  yourApiKey: { pt: 'Sua API Key', en: 'Your API Key', es: 'Tu API Key' },
  apiKeySaved: { pt: 'Chave API salva localmente.', en: 'API Key saved locally.', es: 'Clave API guardada localmente.' },
  apiKeyRemoved: { pt: 'Chave API removida.', en: 'API Key removed.', es: 'Clave API eliminada.' },
  enterKeyBeforeTest: { pt: 'Informe a chave API antes de testar.', en: 'Enter API key before testing.', es: 'Ingresa la clave API antes de probar.' },
  testingConnection: { pt: 'Testando conexão com Gemini...', en: 'Testing connection with Gemini...', es: 'Probando conexión con Gemini...' },
  testPrompt: { pt: "Responda apenas com a palavra 'OK' se você estiver recebendo esta mensagem.", en: "Respond only with the word 'OK' if you are receiving this message.", es: "Responde solo con la palabra 'OK' si estás recibiendo este mensaje." },
  connectionSuccess: { pt: 'Conexão estabelecida com sucesso! A IA respondeu: ', en: 'Connection established successfully! AI responded: ', es: '¡Conexión establecida con éxito! La IA respondió: ' },
  iaUnexpectedResponse: { pt: 'A IA respondeu, mas o conteúdo foi inesperado: ', en: 'AI responded, but content was unexpected: ', es: 'La IA respondió, pero el contenido fue inesperado: ' },
  connectionError: { pt: 'Erro na conexão: ', en: 'Connection error: ', es: 'Error en la conexión: ' },
  profileDataNotLoaded: { pt: 'Dados do perfil não carregados no SubscriptionContext. Tente atualizar a página.', en: 'Profile data not loaded in SubscriptionContext. Try refreshing the page.', es: 'Datos del perfil no cargados en SubscriptionContext. Intenta actualizar la página.' },
  profileDataTitle: { pt: 'Perfil (Supabase):', en: 'Profile (Supabase):', es: 'Perfil (Supabase):' },
  statusContext: { pt: 'Status do Contexto:', en: 'Context Status:', es: 'Estado del Contexto:' },
  clearKey: { pt: 'Limpar chave', en: 'Clear key', es: 'Limpiar clave' },
  getApiKeyAt: { pt: 'Obter chave em', en: 'Get key at', es: 'Obtener clave en' },
  saveKey: { pt: 'Salvar Chave', en: 'Save Key', es: 'Guardar Clave' },
  testActions: { pt: 'Ações de Teste', en: 'Test Actions', es: 'Acciones de Prueba' },
  testIaConnection: { pt: 'Testar Conexão IA', en: 'Test AI Connection', es: 'Probar Conexión IA' },
  viewProfileData: { pt: 'Ver Dados Perfil', en: 'View Profile Data', es: 'Ver Datos Perfil' },
  diagnosticResult: { pt: 'Resultado do Diagnóstico', en: 'Diagnostic Result', es: 'Resultado del Diagnóstico' },
  devModeWarning: { pt: 'O Modo Desenvolvedor permite verificar a integridade da conexão direta com os serviços do Google.', en: 'Developer Mode allows checking the integrity of direct connection with Google services.', es: 'El Modo Desarrollador permite verificar la integridad de la conexión directa con los servicios de Google.' },
  versioning: { pt: 'Versionamento', en: 'Versioning', es: 'Versionamiento' },
  ...
  versionWarning: { pt: 'A versão é incrementada manualmente a cada ciclo de atualização do sistema.', en: 'The version is manually incremented at each system update cycle.', es: 'La versión se incrementa manualmente en cada ciclo de actualización del sistema.' },
  ...
  premiumPerYear: { pt: 'Acesso Premium por 1 ano', en: 'Premium access for 1 year', es: 'Acceso Premium por 1 año' },
  pricingFeature1: { pt: 'Scanner de cupons com IA', en: 'AI-powered receipt scanner', es: 'Escáner de cupones con IA' },
  ...
  finishShoppingPrompt: { pt: 'Selecione os itens comprados e clique em "Encerrar Compras".', en: 'Select purchased items and click "End Shopping".', es: 'Selecciona los ítems comprados y haz clic en "Finalizar Compras".' },
  selectAtLeastOne: { pt: 'Selecione pelo menos um item antes de encerrar.', en: 'Select at least one item before ending.', es: 'Selecciona al menos um ítem antes de finalizar.' },
  locationObtained: { pt: 'Localização obtida!', en: 'Location obtained!', es: '¡Ubicación obtenida!' },
  coordsSaved: { pt: 'Coordenadas salvas (sem acesso à internet para nome da rua).', en: 'Coordinates saved (no internet for street name).', es: 'Coordenadas guardadas (sin internet para el nombre).' },
  locationError: { pt: 'Não foi possível obter localização.', en: 'Could not get location.', es: 'No se pudo obtener la ubicación.' },
  enterLocation: { pt: 'Informe o local de compras.', en: 'Enter shopping location.', es: 'Informa el local de compras.' },
  shoppingEnded: { pt: 'Compras encerradas! Lista concluída.', en: 'Shopping ended! List completed.', es: '¡Compras finalizadas! Lista completada.' },
  ...
  // AppMenu extra strings
  aiDiagnosis: { pt: 'Diagnóstico', en: 'Diagnosis', es: 'Diagnóstico' },
  testIAConnection: { pt: 'Testar Conexão IA', en: 'Test IA Connection', es: 'Probar Conexión IA' },
  viewProfileData: { pt: 'Ver Dados Perfil', en: 'View Profile Data', es: 'Ver Datos Perfil' },
  testingIAConnection: { pt: 'Testando conexão com Gemini...', en: 'Testing connection with Gemini...', es: 'Probando conexión con Gemini...' },
  iaConnectionSuccess: { pt: 'Conexão estabelecida com sucesso!', en: 'Connection established successfully!', es: '¡Conexión establecida con éxito!' },
  iaUnexpectedResponse: { pt: 'A IA respondeu, mas o conteúdo foi inesperado:', en: 'AI responded, but content was unexpected:', es: 'La IA respondió, pero el contenido fue inesperado:' },
  connectionError: { pt: 'Erro na conexão:', en: 'Connection error:', es: 'Error en la conexión:' },
  enterApiKeyBeforeTest: { pt: 'Informe a chave API antes de testar.', en: 'Enter API key before testing.', es: 'Ingresa la clave API antes de probar.' },
  profileDataNotLoaded: { pt: 'Dados do perfil não carregados. Tente atualizar.', en: 'Profile data not loaded. Try refreshing.', es: 'Datos del perfil no cargados. Intenta actualizar.' },
  disableDevMode: { pt: 'Desativar Modo Desenvolvedor', en: 'Disable Developer Mode', es: 'Desactivar Modo Desarrollador' },
  backToNormalAuth: { pt: 'Voltar ao fluxo normal de auth', en: 'Back to normal auth flow', es: 'Volver al flujo normal de auth' },
