...
const translations: Record<string, Record<Lang, string>> = {
  ...
  cheaperLabel: { pt: 'mais barato', en: 'cheaper', es: 'más barato' },
  expensiveLabel: { pt: 'mais caro', en: 'more expensive', es: 'más caro' },
  thanPrevious: { pt: 'em relação ao histórico', en: 'compared to history', es: 'en relación al historial' },
